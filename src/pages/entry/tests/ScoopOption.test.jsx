...
test.only('should indicate if scoop count in non-int out of range', () => {
  ...
  // note: here we're testing our validation rules (namely that the input can display as valid) and not react-bootstrap's response
  userEvent.clear(vanillaInput)
